...
# -----------------------------
# Fetch Data (Alpha + Finnhub)
# -----------------------------
@st.cache_data(ttl=300)
def fetch_data(symbol):

    ALPHA_KEY = "21FQV3XWTO7GVI6M"
    FINNHUB_KEY = "d7nlp79r01qm3636uragd7nlp79r01qm3636urb0"
    ...
    try:
        ...
        if "Note" in data:
            raise Exception("Alpha Vantage limit reached")
...
if data is None or data.empty:
    st.error("Data not available (API limit or invalid ticker).")
    st.stop()
